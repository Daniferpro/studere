              ...
              <ul class="treeview-menu">
                ...
                <li class="active treeview">
                  ...
                  <ul class="treeview-menu">
                    ...
                    <li class="active"><a href="./usuario_contraseña.php?id=<?php echo $id;?>"><i class="fa fa-circle-o"></i> Usuario & Contraseña</a></li>
                  </ul>
                </li>
                <li class="treeview">
        ...
        <div class="col-md-3">
          ...
          <div class="box box-primary">
            ...
            <div class="box-body">
              ...
              <p class="text-muted">
                Las contraseñas son encriptadas para poder garantizar una mayor seguridad.
              </p>
            ...
            <ul class="nav nav-tabs">
              ...
              <div class="tab-pane" id="settings">
                <form class="form-horizontal" action="" method="post">
                  ...
                  <div class="form-group">
                    <label for="inputEmail" class="col-sm-2 control-label">Contraseña Nueva</label>

                    <div class="col-sm-10">
                      <input type="password" class="form-control" name="pass1" id="inputEmail" placeholder="Ingrese Una Nueva Contraseña">
                    </div>
                  </div>
                  <div class="form-group">
                    <label for="inputEmail" class="col-sm-2 control-label">Repita Contraseña</label>

                    <div class="col-sm-10">
                      <input type="password" class="form-control" name="pass2" id="inputEmail" placeholder="Repita la Nueva Contraseña">
                    </div>
                  </div>
                  <input type="text" name="oculto" hidden>
                  
                  <div class="form-group">
                    <div class="col-sm-offset-2 col-sm-10">
                      <button type="submit" class="btn btn-danger">Actualizar</button>
                      
                      <a  class="btn btn-success" href="./usuario_contraseña.php?id=<?php echo $id; ?>">refrescar</a>
