<?php 
  ...
  if(isset($_COOKIE['status']) && $_COOKIE['status'] == "online"){
  ...
  <div class="login-box-body">
    ...
    <form action="./procesos/login.php" method="post">
      <div class="form-group has-feedback">
        <input type="email" class="form-control" name="email" placeholder="Email" value="<?php if(isset($_GET['email'])){ print $_GET['email'];}?>" >
