      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            ...
            <li><a href="#"><i class="fa fa-circle-o"></i> Software a utilizar</a></li>
            </ul>
        </li>
        <!-- <li class="treeview">
          <a href="#">
            ...
            <li class="active treeview">
              ...
              <ul class="treeview-menu">
                ...
                <li class="active treeview">
                  ...
                  <ul class="treeview-menu">
                    <li class="active"><a href="#"><i class="fa fa-circle-o"></i> Datos de Contacto</a></li>
        ...
        <div class="col-md-3">
          ...
          <div class="box box-primary">
            <div class="box-body box-profile">
              ...
              <h3 class="profile-username text-center"><?php echo $User->nombre . " ".  $User->apellido;?></h3>

              <p class="text-muted text-center"><?php echo $User->materia;?></p>
              ...
              <ul class="list-group list-group-unbordered">
                ...
                <li class="list-group-item">
                  <b>Celular</b> <a class="pull-right"><?php echo $User->celular;?></a>
                </li>
                <li class="list-group-item">
                  <b>Asignatura</b> <a class="pull-right"><?php echo $User->materia;?></a>
                </li>
              </ul>
          ...
          <div class="box box-primary">
            <div class="box-header with-border">
              <h3 class="box-title">Documentos de Interes</h3>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
              <strong><i class="fa fa-book margin-r-5"></i> Acuerdo</strong>

              <p class="text-muted">
                Acuerdo entre las partes del equipo Studere
              </p>
              ...
              <strong><i class="fa fa-file-text-o margin-r-5"></i> Descargar documento:</strong>

              <p><a download="Acuerdo de Responsabilidad Studere-Docente" href="../documentos/Acuerdo.pdf">Acuerdo de Responsabilidades.pdf </a> </p>
            </div>
            <!-- /.box-body -->
          </div>
          <!-- /.box -->
        ...
        <div class="col-md-9">
          <div class="nav-tabs-custom">
            <ul class="nav nav-tabs">
              <li><a href="#settings" data-toggle="tab">Editar Mis Datos</a></li>
            </ul>
              ...
              <div class="tab-pane" id="settings">
                <form class="form-horizontal" action="" method="post">
                  <div class="form-group">
                    ...
                    <div class="col-sm-10">
                      <input type="text" class="form-control" name="nombre_nuevo" id="inputName" placeholder="<?php echo $User->nombre;?>">
                    </div>
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-sm-10">
                      <input type="text" class="form-control" name="apellido_nuevo" id="inputName" placeholder="<?php echo $User->apellido;?>">
                    </div>
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-sm-10">
                      <input type="email" class="form-control" name="email_nuevo" id="inputEmail" placeholder="<?php echo $User->email;?>">
                    </div>
                  </div>
                  <div class="form-group">
                    ...
                    <div class="col-sm-10">
                    <input name="oculto" hidden>  
                    <input type="number" class="form-control" id="inputName" name="celular_nuevo" placeholder="<?php echo $User->celular;?>">
                    </div>
                  </div>
                  ...
                  <div class="form-group">
                    <div class="col-sm-offset-2 col-sm-10">
                      ...
                      <a  class="btn btn-success" href="./datos_de_contacto.php?id=<?php echo $id; ?>">refrescar</a>
...
if(isset($_POST['oculto']))
{
  ...
  if(isset($_POST['nombre_nuevo'])){
    if(!empty($_POST['nombre_nuevo'])){
      $valor = $_POST['nombre_nuevo'];
      $campo = "Nombre";
  ...
  if(isset($_POST['apellido_nuevo'])){
    if(!empty($_POST['apellido_nuevo'])){
      $valor = $_POST['apellido_nuevo'];
      $campo = "Apellido";
      $User->actualizar($campo, $valor);

    }
  }
  if(isset($_POST['celular_nuevo'])){
    if(!empty($_POST['celular_nuevo'])){
      $valor = $_POST['celular_nuevo'];
      $campo = "Celular";
      $User->actualizar($campo, $valor);
