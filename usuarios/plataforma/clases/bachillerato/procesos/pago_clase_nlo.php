...
$preference = new MercadoPago\Preference();
  ...
  $payer->email = $emailusr;
  

  # url de retorno segun resultado de la compra
  $preference->back_urls = array(
    "success" => "localhost/payment-succcess.php?aprobado=true&reference=$id",
                ...
                <div class="col">
                    <div class="header_content d-flex flex-row align-items-center justify-content-start">
                        <div class="logo_container">
                            <a href="../index.php">
                                <div class="logo_text">Carrito <span><?php echo $emailusr;?></span> </div>
                            </a>
                        </div>
				...
				<div class="col-lg-4">
					<div class="sidebar course">
                        ...
                        <br>
                            ...
                            <form action="../../../../../../payment-success.php?aprobado=true&reference=<?php echo $id;?>&materia=<?php echo $materia;?>    " method="POST">
  <script
