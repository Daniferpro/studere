...
<body class="hold-transition skin-blue sidebar-mini" onload="comentarios();">
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        Mailbox
        <small><?php include "./includes/mensajes_alumnos_numero.php"; ?> mensajes nuevos</small>
      </h1>
      <ol class="breadcrumb">
          ...
          <div class="box box-solid">
            ...
            <div class="box-body no-padding">
              <ul class="nav nav-pills nav-stacked">
                <li class="active"><a href="#"><i class="fa fa-inbox"></i> Mensajes Nuevos
            ...
            <div class="box-body no-padding">
              ...
              <div class="table-responsive mailbox-messages">
                <table class="table table-hover table-striped">
                  <tbody>
                  <?php include "./includes/mensajes_alumnos_lista.php";?>
                  </tbody>
                </table>
                <!-- /.table -->
              </div>
...
<?php 
if(isset($_POST['alumno'])):  $id_alumno = $_POST['alumno'];
?>
<script>
Command: toastr["info"]('Esta seguro/a de eliminar todo el CHAT ? <br /><br /><form action="" method="post"><button name="eliminar_alumno" value="<?php echo $id_alumno;?>" type="submit" class="btn clear">SI ELIMINAR</button></form>', "IMPORTANTE")
