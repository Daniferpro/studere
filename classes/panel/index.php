  ...
  <script type="text/javascript">
   ...
   <script type="text/javascript">
		function comentarios(){
			...
			//linea que hace que se refreseque la pagina cada segundo
		setInterval(function(){comentarios();}, 1000);	
        ...
        <ul class="nav navbar-nav">
          ...
          <li class="dropdown user user-menu">
            <a href="" class="dropdown-toggle" data-toggle="dropdown">
              <img src="../dist/img/avatar5.png" class="user-image" alt="User Image 1">
              <span class="hidden-xs"><?php echo $nombre_apellido;?></span>
            </a>
            <ul class="dropdown-menu">
              <!-- User image --> 
              <li class="user-header">
                <img src="../dist/img/avatar5.png" class="img-circle" alt="User Image 2">
    ...
    <section class="sidebar">
      ...
      <div class="user-panel">
        <div class="pull-left image">
          <img src="../dist/img/avatar5.png" class="img-circle" alt="User Image 3">
        </div>
