...
<head>
  ...
  <script type="text/javascript">
		function chat_ajax(){
			...
			req.onreadystatechange = function(){
				if (req.readyState == 4 && req.status == 200) {
					document.getElementById('mensajeria').innerHTML = req.responseText;
				}
			}

			req.open('GET', 'chat_ajax.php?<?php echo "email=".$email."&materia=".$materia;?>', true);
			req.send();
		}
        ...
        <div class="col-md-3">
          ...
          <div class="box box-solid">
            <div class="box-header with-border">
              <h3 class="box-title">Mis Materias</h3>
          ...
          <div class="box box-primary">
            ...
            <div class="box-body no-padding">
              <div class="mailbox-controls">
                ...
                <div class="btn-group">
                  <button type="button" class="btn btn-default btn-sm"><i class="fa fa-trash-o"></i> Vaciar Bandeja de Entrada</button>
              ...
              <div class="table-responsive mailbox-messages">
                <table class="table table-hover table-striped">
                  ...
                  <tr>
                    ...
                    <td class="mailbox-name"><a href="read-mail.html">Rogelio Castro</a></td>
                    <td class="mailbox-subject"><b>Perfecto sabes que en éste tema</b> - debemos buscar una solucion...
                    </td>
                    <td class="mailbox-attachment"></td>
                    <td class="mailbox-date">hoy</td>
                  </tr>
                  </tbody>
                </table>
                <!-- /.table -->
