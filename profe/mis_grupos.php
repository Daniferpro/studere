          ...
          <div class="box box-info">
            ...
            <form class="form-horizontal" method="post" action="">
              ...
              <div class="form-group">
                  ...
                  <div class="col-sm-10">
                    <input type="text" name="horario" class="form-control" id="text" placeholder="Ejemplo: De 18:00 a 18:40 " required>
                  </div>
                  <label for="inputEmail3" class="col-sm-2 control-label">Dia de Inicio</label>

                  <div class="col-sm-10">
                    <input type="date" name="dia" class="form-control" id="text" placeholder="Selecciones dia de inicio " required>
                  </div>
                </div>
                <div class="form-group">
                  ...
                  <div class="col-sm-10">
                    <input type="text" name="link" class="form-control" id="text" placeholder="Link de video conferencia" required>
                  </div>
                </div>
                <div class="form-group">
                  <label for="inputEmail3" class="col-sm-2 control-label">Contraseña de vc</label>

                  <div class="col-sm-10">
                    <input type="text"name="pass"  class="form-control" id="telphone" placeholder="Contraseña de Video Conferecia">
                  </div> 
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-10">
                    <input type="text" name="grupo" class="form-control" id="text" placeholder="Numero de Grupo Ej: 3" required>
                  </div>
                </div>
