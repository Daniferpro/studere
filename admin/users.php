...
$registros_totales = consultarSQL(" SELECT * FROM usuario ") ->num_rows;

//cuenta de ventas totales exitosas

$numeroVentasTotales = consultarSQL(" SELECT * FROM fatura WHERE status='Aprovado' ") ->num_rows;
      ...
      <div class="row">
        ...
        <div class="col-lg-3 col-xs-6">
          ...
          <div class="small-box bg-red">
            <div class="inner">
              <h3><?php echo $usuariosEnLinea -1;?></h3>
         ...
         <div class="box box-info">
            ...
            <form class="form-horizontal" method="post" action="#">
              ...
              <div class="form-group">
                  ...
                  <div class="col-sm-10">
                    <input type="text" name="nombre" class="form-control" id="text" placeholder="Nombre" required>
                  </div>
                </div>
                <div class="form-group">
                  ...
                  <div class="col-sm-10">
                    <input type="text" name="apellido" class="form-control" id="text" placeholder="Apellido" required>
                  </div>
                </div>
                <div class="form-group">
                  ...
                  <div class="col-sm-10">
                    <input type="number"name="celular" maxlength="9" oninput="if(this.value.length > this.maxLength) this.value = this.value.slice(0, this.maxLength);"  class="form-control" id="telphone" placeholder="Celular">
                  </div>
                </div>
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-offset-2 col-sm-10">
                    ...
                    <button type="" class="btn btn-sm btn-default btn-flat pull-left">El nuevo usuario no requiere Verificación de cuenta</button>
...
<?php
if(isset($_POST['tipo']))
{include "./includes/nuevo_usuario.php";}
?>
<!-- jQuery 3 -->
