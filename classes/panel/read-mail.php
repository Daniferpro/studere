...
$id = $_SESSION['id'];
$chat_id= $_GET['id_alumno'];
$Alumno = new Alumno($id);
$Alumno_destino = new Alumno($chat_id);
$nombre_alumno_destino = $Alumno_destino->nombre . " " . $Alumno_destino->apellido;
...
while($mensaje = mysqli_fetch_assoc($mensajes_alumno)){    
    ...
    $msg_id = $mensaje['id'];
    consultachatSQL("UPDATE `$id` SET estado=1 WHERE ID='$msg_id' ");
}}
...
$consulta1 = consultarSQL("SELECT * FROM fatura WHERE data='$id' AND status='Aprovado' ");
...
<head>
  ...
  <title>Studere.uy | Mensajes</title>
...
<script type="text/javascript">
		function chat(){
			...
			req.open('GET', '../includes/mensajes.php?id=<?php echo $_GET['id'];?>&id_alumno=<?php echo $_GET['id_alumno'];?>&materia=<?php echo $Alumno_destino->materia;?>', true);
			req.send();
		}
...
<body class="hold-transition skin-blue sidebar-mini" onload="chat();">
<div class="wrapper">
      ...
      <div class="navbar-custom-menu">
        <ul class="nav navbar-nav">
          ...
          <li class="dropdown notifications-menu">
            <a href="#" class="dropdown-toggle" data-toggle="dropdown">
              <i class="fa fa-envelope-o"></i>
              <span class="label label-warning"><?php $Alumno->numeroMensajesNuevos();?></span>
            </a>
            <ul class="dropdown-menu">
              ...
              <li class="footer"><a href="./mailbox.php?id=<?php echo $id;?>&materia=<?php echo $Alumno->materia;?>">Ir a mensajes</a></li>
            </ul>
          </li>
          ...
          <li class="dropdown user user-menu">
            ...
            <ul class="dropdown-menu">
              ...
              <li class="user-header">
                ...
                <p>
                <?php  echo $Alumno->nombre. " " . $Alumno->apellido . " - " . $Alumno->materia ; ?>
                  <small><?php  echo $Alumno->celular; ?></small>
                </p>
              </li>
              <!-- Menu Body -->
              <li class="user-body">
      ...
      <li class="header">Menú avanzado</li>
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            ...
            <li class="treeview">
              <a href="#"><i class="fa fa-circle-o"></i> <?php echo $Alumno->nombre. " " . $Alumno->apellido; ?>
                <span class="pull-right-container">
                  <i class="fa fa-angle-left pull-right"></i>
                </span>
              </a>
            ...
            <div class="box-body no-padding">
              <ul class="nav nav-pills nav-stacked">
                <li class="active"><a href="#"><i class="fa fa-inbox"></i> Mensajes:
                  <span class="label label-primary pull-right"><?php $Alumno->numeroMensajesNuevos(); ?></span></a></li>
                  <?php # include "./includes/lista_de_alumnos_para_chat.php";?>
          ...
          <div class="box box-primary">
            ...
            <div class="box-body no-padding">
              <div class="mailbox-read-info">
                <h3>Mensajes Recividos</h3>
                <h5> Chat con <?php echo $Alumno_destino->nombre ." ". $Alumno_destino->apellido;
                                ?>
              ...
              <form action="#" method="post">
                ...
                <div>
                  <textarea class="" name="mensaje" placeholder=" Escribe tu mensaje....."
                            style="width: 100%; height: 125px; font-size: 14px; line-height: 18px; border: 1px solid #dddddd; padding: 10px;"></textarea>
                </div>
             
            </div>
            <div class="box-footer clearfix">
            <a type="button" href="./read-mail.php?id=<?php $chat_id = $_GET['id_alumno']; echo $id;?>&id_alumno=<?php echo $chat_id;  ?>"  class="pull-left btn btn-default" >Actualizar
           ...
           $id_usuario= $_GET['id'];
                  if(isset($_POST['mensaje'])){
                    ...
                    if(!empty($_POST['mensaje'])){
                      ...
                      $msg = $_POST['mensaje'];
                      $Alumno->enviarMensaje($id_destino, $msg);
                     }else{
                        echo '
                                      <div class="info-box">
                                        ...
                                        <div class="info-box-content">
                                          <span class="info-box-text">Mensaje NO enviado</span>
                                          <span class="info-box-number">No puedes enviar un mensaje vacío.. </span>
                                        </div>
                    ...
                    $chat_usuario="CREATE TABLE IF NOT EXISTS `$id_usuario` 
                    ...
                    $chat_destino="CREATE TABLE IF NOT EXISTS `$id_destino` 
                    ( `id` INT NOT NULL AUTO_INCREMENT ,
                    `Nombre` VARCHAR(100) NOT NULL ,
                    `mensaje` TEXT(500) NOT NULL ,
                      `destinatario` VARCHAR(100) NOT NULL ,
                    ...
                    consultachatSQL($chat_usuario);
                    consultachatSQL($chat_destino);
            ...
            <div class="box-footer">
              ...
              <button type="button" class="btn btn-default"><i class="fa fa-trash-o"></i> borrar todo el chat</button>
              <button type="button" target="_blank" onclick="printDiv('mensajes')" class="btn btn-default"><i class="fa fa-print"></i> imprimir mensajes</button>
            </div>
            <!-- /.box-footer -->
          </div>
          <!-- /. box -->
  ...
  <footer class="main-footer">
    ...
    <strong>Copyright &copy; 2019-2020 <a href="https://studere.uy">Studere.uy</a></strong> All rights
    reserved.
  </footer>
