...
$materia_profe = $usuario['materias'];
$id_alumno= $_GET['id_alumno'];

# aqui actualizaremos los mensajes enviados de los alumnos de no leidos a leidos.

$mensajes_alumno = consultachatSQL("SELECT * FROM `$id_alumno` WHERE materia='$materia_profe'");
if($mensajes_alumno){
while($mensaje = mysqli_fetch_assoc($mensajes_alumno)){    

    $msg_id = $mensaje['id'];
    consultachatSQL("UPDATE `$id_alumno` SET estado=1 WHERE ID='$msg_id' ");
}}
...
<script type="text/javascript">
		function chat(){
			...
			req.open('GET', './includes/mensajes.php?id=<?php echo $_GET['id'];?>&id_alumno=<?php echo $_GET['id_alumno'];?>&materia=<?php echo $materia_profe;?>', true);
			req.send();
		}
      ...
      <div class="navbar-custom-menu">
        <ul class="nav navbar-nav">
          ...
          <li class="dropdown notifications-menu">
            <a href="#" class="dropdown-toggle" data-toggle="dropdown">
              <i class="fa fa-envelope-o"></i>
              <span class="label label-warning"><?php include "./includes/mensajes_alumnos_numero.php";?></span>
            </a>
            <ul class="dropdown-menu">
              ...
              <li class="footer"><a href="./mailbox.php?id=<?php echo $id_profe;?>&materia=<?php echo $materia_profe;?>">Ir a mensajes</a></li>
            </ul>
          </li>
            ...
            <div class="box-body no-padding">
              <ul class="nav nav-pills nav-stacked">
                <li class="active"><a href="#"><i class="fa fa-inbox"></i> Mensajes:
                  <span class="label label-primary pull-right"><?php include "./includes/mensajes_alumnos_numero.php"; ?></span></a></li>
          ...
          <div class="box box-primary">
            ...
            <div class="box-body no-padding">
              <div class="mailbox-read-info">
                ...
                <h5> Alumno : <?php $alumno = mysqli_fetch_assoc(consultarSQL("SELECT * FROM usuario WHERE id='$_GET[id_alumno]'"));
            ...
            <?php  
                ...
                $id_alumno= $_GET['id_alumno'];
                 ...
                 $guardar_chat =  consultachatSQL("INSERT INTO `$id_alumno` (`id`, `Nombre`, `mensaje`, `materia`, `fecha`, `estado` ) 
                 VALUES (NULL, '$nombre ', '$mensaje', '$materia', current_timestamp(), '0')");
                    ...
                    $crear_chat = consultachatSQL($chat);
