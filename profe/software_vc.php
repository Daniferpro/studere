      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="">
          ...
          <ul class="treeview-menu">
            ...
            <li><a href="#"><i class="fa fa-circle-o"></i> Video Conferencias</a></li>
          </ul>
        </li>
        ...
        <li class="active treeview">
          ...
          <ul class="treeview-menu">
            ...
            <li  class="active"><a href="#"><i class="fa fa-circle-o"></i> Software a utilizar</a></li>
            </ul>
        </li>
        <!-- <li class="treeview">
          <a href="#">
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="">panel</li>
        <li class="active">Opciones VC</li>
      </ol>
    </section>
        ...
        <section class="col-lg-12 connectedSortable">
         ...
         <div class="box box-info">
            <div class="box-header with-border">
              <h3 class="box-title">Software Recomendado para realizar las Video Conferencias</h3>
              ...
              <div class="table-responsive">
                <table class="table no-margin">
                  ...
                  <tr>
                    ...
                    <th>Almacenamiento de Grabación</th>
                
                    <th>Tiempo de Reunión</th>
                  ...
                  <tr>
                    <td>Zoom</td>
                    <td><a href="https://zoom.us/download#client_4meeting"> https://zoom.us/download#client_4meeting</a></td>
                    <td>En Local</td>
                    <td>40 Minutos</td>
                  </tr>
                  <tr>
                    <td>Webex Meetings</td>
                    <td><a href="https://www.webex.com/es/downloads.html">https://www.webex.com/es/downloads.html</a></td>
                    <td>En la Nube</td>
                    <td>40 Minutos</td>
                  </tr> 
                   </tbody>
          ...
          <div class="box box-info">
            <div class="box-header with-border">
              <h3 class="box-title">Si desea conocer más caracteristicas del software presione <a href="https://www.getapp.es/compare/10375/111633/cisco-webex/vs/zoom">Aquí</a> para visitar una lista de diferencias</h3>
            </div>
            <!-- /.box-header -->
