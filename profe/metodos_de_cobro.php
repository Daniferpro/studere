...
<div class="wrapper">
            ...
            <li class="active treeview">
              ...
              <ul class="treeview-menu">
                ...
                <li class="active treeview">
                  ...
                  <ul class="treeview-menu">
                    <li class="active"><a href="#"><i class="fa fa-circle-o"></i> Métodos de Cobro</a></li>
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        Metodos de Cobro
        <small>Numeros de cuenta</small>
      </h1>
      <ol class="breadcrumb">
        <li><a href="#"><i class="fa fa-dashboard"></i> Inicio</a></li>
        <li class="">panel</li>
        <li class="active">Perfil Comercial</li>
      </ol>
    </section>
            ...
            <div class="box-body box-profile">
              ...
              <ul class="list-group list-group-unbordered">
                <li class="list-group-item">
                  <b>Tipo de Cuenta</b> <a class="pull-right"><?php echo $datos_profe['Tipo_de_cuenta'];?></a>
                </li>
                <li class="list-group-item">
                  <b>Numero de Cuenta</b> <a class="pull-right"><?php echo base64_decode($datos_profe['Cuenta']);?></a>
                </li>
                ...
                <form class="form-horizontal" action="" method="post">
                  ...
                  <div class="form-group">
                    <div class="col-sm-offset-2 col-sm-10">
                      ...
                      <a  class="btn btn-success" href="./metodos_de_cobro.php?id=<?php echo $id; ?>">refrescar</a>
