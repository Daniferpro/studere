      ...
      <div class="row">
        ...
        <div class="col-lg-3 col-xs-6">
          ...
          <div class="small-box bg-yellow">
            ...
            <a href="./users.php?id=<?php echo $id;?>" class="small-box-footer">Lista de Usuarios <i class="fa fa-arrow-circle-right"></i></a>
          </div>  
        </div>
        <!-- ./col -->
        <div class="col-lg-3 col-xs-6">
      ...
      <div class="row">
        ...
        <section class="col-lg-7 connectedSortable">
          ...
          <div class="box box-success">
            <div class="box-header">
              ...
              <h3 class="box-title">Comentarios de alumnos</h3>
        ...
        <section class="col-lg-5 connectedSortable">
          ...
          <div class="box box-solid bg-light-blue-gradient">
            ...
            <div class="box-body">
            <video src="./crear_clases.mp4" controls="true" width="100%"></video>
            </div>
            <!-- /.box-body-->
            ...
            <div class="box-body">
            <video src="./Juntos Podemos Mas.mp4" controls="true" width="100%"></video>
            </div>
            <!-- /.box-body-->
            <div class="box-footer no-border">
