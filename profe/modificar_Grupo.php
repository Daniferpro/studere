...
$grupo_id_get = $_GET['grupo'];
$materia = $usuario['materias'];

$Grupo = New Grupo($grupo_id_get,$materia);
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="active treeview">
          ...
          <ul class="treeview-menu">
            ...
            <li  class="active"><a href="./mis_grupos.php?id=<?php echo $id;?>"><i class="fa fa-circle-o"></i> Video Conferencias</a></li>
          </ul>
        </li>
            ...
            <form class="form-horizontal" method="post" action="">
              ...
              <div class="form-group">
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-10">
                    <input type="text" name="nuevo_link" class="form-control" id="text" placeholder="Link Actual : <?php echo $Grupo->link_vc;?>  " >
                  </div>
                </div>
                <div class="form-group">
