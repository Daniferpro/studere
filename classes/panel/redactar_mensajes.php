...
<div class="wrapper">
            ...
            <ul class="dropdown-menu">
              ...
              <li class="user-footer">
                ...
                <div class="pull-right">
                  <a href=""# class="btn btn-default btn-flat">Estás en el chat con: <?php print $materia;?></a>
                </div>
              </li>
            </ul>
          </li>
  ...
  <div class="content-wrapper">
    ...
    <section class="content">
      <div class="row">
        <div class="col-md-3">
          <a href="compose.html" class="btn btn-primary btn-block margin-bottom">No has enviado mensajes a este profesor</a>

          <div class="box box-solid">
            <div class="box-header with-border">
              <h3 class="box-title">Escribir mensajes a:</h3>
            ...
            <div class="box-body no-padding">
              ...
              <!-- mostrar lista de mis materia con acceso a chat con el profesor -->
                <li class="active"><a href="#"><i class="fa fa-inbox"></i> Hitoria
                  
                <li><a href="#"><i class="fa fa-envelope-o"></i> Matematicas</a></li>
          ...
          <div class="box box-primary">
            ...
            <div class="box-body no-padding">
              <div class="mailbox-controls">
                ...
                <div class="btn-group">
                  <button type="button" class="btn btn-default btn-sm"><i class="fa fa-trash-o"></i> Vaciar Bandeja de esta Asignatura</button>
