      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="active treeview">
          ...
          <ul class="treeview-menu">
            <li class="active"><a href="#"><i class="fa fa-circle-o"></i> General</a></li>
            <li><a href="index2.html"><i class="fa fa-circle-o"></i> Alumnos</a></li>
            <li><a href="index2.html"><i class="fa fa-circle-o"></i> Profesores</a></li>
          </ul>
        </li>
        <!-- <li class="treeview">
          <a href="#">
        ...
        <section class="col-lg-7 connectedSortable">
          ...
          <div class="nav-tabs-custom">
            ...
            <ul class="nav nav-tabs pull-right">
              <li class="active"><a href="#revenue-chart" data-toggle="tab">Ventas</a></li>
